...
(function ($) {
  ...
  function initPreview() {
    ...
    var classes = "position-".concat(position, " merchant-product-labels__").concat(labelType);
  ...
  var updateStyles = function updateStyles(shapeType, selectedShape, $input) {
    ...
    for (var _i = 0, _Object$entries = Object.entries(properties); _i < _Object$entries.length; _i++) {
      ...
      var value = (_shapesDefaultStyles$ = shapesDefaultStyles[shapeType][selectedShape]) === null || _shapesDefaultStyles$ === void 0 ? void 0 : _shapesDefaultStyles$[propertyName];
      if (value || value === 0) {
